        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-bold uppercase tracking-wider text-purple-700">
              Fase Beta Público • Limitado a 30 Vagas
            </span>
          </div>
        ...
        <div className="pt-4 space-y-3">
          ...
          <div className="text-center space-y-1.5 pt-1">
            <p className="text-xs text-purple-950 font-bold">
              ✨ 7 dias gratuitos na 1ª assinatura • Sem cobrança hoje
            </p>
            <p className="text-[11px] text-purple-900/60 leading-normal">
              Condição especial para as 30 primeiras usuárias Beta. Cancele quando quiser no painel sem fidelidade.
            </p>
          </div>
        </div>
      </div>
