...
export function LandingPricingCard({ plan, user }: LandingPricingCardProps) {
  ...
  return (
    <div
      className={`relative w-full max-w-md mx-auto rounded-3xl p-8 sm:p-10 shadow-lg hover:shadow-xl overflow-hidden transition-all duration-300 animate-pricing-card opacity-0 flex flex-col justify-between ${isFeatured
      ...
      <div className="space-y-6">
        ...
        <div className="text-center pt-2 space-y-2">
          <p className="text-xs text-purple-900/60 font-medium">
            Processado com segurança via <strong className="text-purple-950 font-bold">Mercado Pago</strong>
          </p>
