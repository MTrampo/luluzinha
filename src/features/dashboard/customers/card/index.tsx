...
export function CustomerCard({ customer }: CustomerCardProps) {
  return (
    <div className="group relative flex gap-4 items-center border border-purple-50 hover:border-purple-200 shadow-sm hover:shadow-md bg-white/80 backdrop-blur-sm p-4 rounded-md cursor-pointer transition-all overflow-hidden duration-300">
