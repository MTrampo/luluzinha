...
# 💅 Diretrizes de Linguagem e UX: Projeto Luluzinha (MVP)

Este documento estabelece os princípios de comunicação para o MVP Luluzinha. O objetivo é garantir que a interface não seja apenas funcional, mas um ambiente de acolhimento para a manicure.
...
*   *Exemplo de busca sem resultado:* "Ainda não encontramos essa Poderosa. Que tal cadastrá-la agora para brilhar na sua agenda?"
...
## 5. Objetivo Final
O usuário deve sentir que o sistema entende a rotina pesada de uma manicure e está ali para ser o braço direito, tornando o trabalho mais agradável e organizado.